...
Redesign of the FitFlow fitness app: AI-personalized workout plans, camera-based nutrition tracking, and a private social community layer.
...
- Database: PostgreSQL
- Real-time / Social: Firebase (Firestore, Realtime Database)
